...
const Register = () => {
  ...
  return (
    <div className="h-svh  w-full bg-background flex items-center py-5 md:px-4 px-2">
      <div className="bg-white border border-slate-200 shadow-sm rounded-3xl p-8 lg:p-10 h-full overflow-y-hidden hover:overflow-y-auto md:w-2/6 w-full">
